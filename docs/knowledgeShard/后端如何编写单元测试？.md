...
很多初学编程的同学都会认为 “程序员的工作只有开发新功能，功能做完了就完事儿”。但其实不然，保证程序的正常运行、提高程序的稳定性和质量也是程序员的核心工作。
...
![](https://czxcab.cn/file/docs/unit1.jpg)



如果结果错误，输出如下，能够清晰地看到执行结果的差异：

![](https://czxcab.cn/file/docs/unit2.jpg)
...
![](https://czxcab.cn/file/docs/unit3.jpg)

然后就能看到测试覆盖度报告了，如下图：

![](https://czxcab.cn/file/docs/unit4.jpg)
...
![](https://czxcab.cn/file/docs/unit5.jpg)


导出后，会得到一个 HTML 静态文件目录，打开 `index.html` 就能在浏览器中查看更详细的单元测试报告了：

![](https://czxcab.cn/file/docs/unit6.jpg)
...
![](https://czxcab.cn/file/docs/unit7.jpg)


测试结束后，就能够在 target 目录中，看到生成的 JaCoCo 单元测试报告网站了：

![](https://czxcab.cn/file/docs/unit8.jpg)


打开网站的 index.html 文件，就能看到具体的测试报告结果，非常清晰：

![](https://czxcab.cn/file/docs/unit9.jpg)
